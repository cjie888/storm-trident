...
public class XMPPFunction extends BaseFunction {
    ...
    public static final String XMPP_TO =
            "storm.xmpp.to";
    public static final String XMPP_USER =
            "storm.xmpp.user";
    public static final String XMPP_PASSWORD =
            "storm.xmpp.password";
    public static final String XMPP_SERVER =
            "storm.xmpp.server";
    ...
    public void prepare(Map conf,
        ...
        ConnectionConfiguration config = new
                ...
                conf.get(XMPP_SERVER));
        this.xmppConnection = new
        ...
        try {
            ...
            LOG.warn("Error initializing XMPP Channel",
                    e);
        }  */
    }
